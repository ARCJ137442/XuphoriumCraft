...
public class XCraftReactions extends Elementsx_craft.ModElement
{
	//============Static============//
	//Consts
	...
	//REACTIONS
	public static final Reaction[] REACTIONS=new Reaction[]{
	...
	//CONUAINERS
	public static final ReactionContainer[] REACTION_CONUAINERS=new ReactionContainer[]{
		CONTAINER_1,
	...
	public XCraftReactions(Elementsx_craft instance)
	{
		super(instance,4);
	}
