...
public class XBoss extends Elementsx_craft.ModElement
{
	...
	public XBoss(Elementsx_craft instance)
	{
		super(instance,2);
	}
	...
	{
		elements.entities.add(()->EntityEntryBuilder.create().entity(EntityXBoss.class).id(new ResourceLocation("x_craft","x_boss"),ENTITYID).name("x_boss").tracker(64,1,true).egg(-3355444,-16711681).build());
		elements.entities.add(()->EntityEntryBuilder.create().entity(EntityBulletCustom.class).id(new ResourceLocation("x_craft","x_boss_bullet"),ENTITYID_RANGED).name("x_boss_bullet").tracker(64,1,true).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		RenderingRegistry.registerEntityRenderingHandler(EntityXBoss.class,renderManager -> {
			RenderBiped customRender=new RenderBiped(renderManager,new ModelBiped(),0.5f)
			{
				...
				{
					return new ResourceLocation("x_craft:textures/x_zombie.png");
				}
			};
