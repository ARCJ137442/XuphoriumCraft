...
public class XCraftBlocks extends Elementsx_craft.ModElement
{
	...
	@GameRegistry.ObjectHolder("x_craft:x_ore")
	public static final Block X_ORE=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_ore_nether")
	public static final Block X_ORE_NETHER=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_ore_end")
	public static final Block X_ORE_END=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_block")
	public static final Block X_BLOCK=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_block_advanced")
	public static final Block X_BLOCK_ADVANCED=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_crystal_block")
	public static final Block X_CRYSTAL_BLOCK=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_dust_block")
	public static final Block X_DUST_BLOCK=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_path")
	public static final Block X_PATH=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_reactive_core")
	public static final Block X_REACTIVE_CORE=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_explosive")
	public static final Block X_EXPLOSIVE=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_curer")
	public static final Block X_CURER=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_dust_generater")
	public static final Block X_DUST_GENERATER=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_liquid")
	public static final Block X_LIQUID=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_glass")
	public static final Block X_GLASS=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_diamond_block")
	public static final Block X_DIAMOND_BLOCK=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_emerald_block")
	public static final Block X_EMERALD_BLOCK=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_ruby_block")
	public static final Block X_RUBY_BLOCK=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_transporter")
	public static final Block X_TRANSPORTER=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_metal_block")
	public static final Block X_METAL_BLOCK=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_covalent_solid")
	public static final Block X_COVALENT_SOLID=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_phase_fiber_block")
	public static final Block X_PHASE_FIBER_BLOCK=null;
	
	@GameRegistry.ObjectHolder("x_craft:x_phase_web_block")
	public static final Block X_PHASE_WEB_BLOCK=null;
	
	//Fluid
	@GameRegistry.ObjectHolder("x_craft:x_fluid")
	...
	//Oxygen
	@GameRegistry.ObjectHolder("x_craft:x_oxygen")
	...
	public XCraftBlocks(Elementsx_craft instance)
	{
		super(instance,3);
		X_FLUID_Fluid=new Fluid("x_fluid",
						new ResourceLocation("x_craft:blocks/x_fluid_still"),
						new ResourceLocation("x_craft:blocks/x_fluid")
						).setDensity(1024).setViscosity(1024).setGaseous(false);
		X_OXYGEN_Fluid=new Fluid("x_oxygen",
						new ResourceLocation("x_craft:blocks/x_oxygen"),
						new ResourceLocation("x_craft:blocks/x_oxygen")
	...
	public void registerModels(ModelRegistryEvent event)
	{
		...
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_ORE),0,new ModelResourceLocation("x_craft:x_ore","inventory"));
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_ORE_NETHER),0,new ModelResourceLocation("x_craft:x_ore_nether","inventory"));
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_ORE_END),0,new ModelResourceLocation("x_craft:x_ore_end","inventory"));
		//Block,BlockAdvanced
		for(i=0;i<16;i++)
		{
			ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_BLOCK),i,new ModelResourceLocation("x_craft:x_block_"+i,"inventory"));
			ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_BLOCK_ADVANCED),i,new ModelResourceLocation("x_craft:x_block_advanced_"+i,"inventory"));
			ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_LIQUID),i,new ModelResourceLocation("x_craft:x_liquid_"+i,"inventory"));
		}
		//CrystalBlock
		for(i=0;i<8;i++) ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_CRYSTAL_BLOCK),i,new ModelResourceLocation("x_craft:x_crystal_block_"+i,"inventory"));//Path
		//DustBlock
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_DUST_BLOCK),0,new ModelResourceLocation("x_craft:x_dust_block","inventory"));
		//Path
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_PATH),0,new ModelResourceLocation("x_craft:x_path","inventory"));
		//ReactiveCore
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_REACTIVE_CORE),0,new ModelResourceLocation("x_craft:x_reactive_core","inventory"));
		//Explosive
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_EXPLOSIVE),0,new ModelResourceLocation("x_craft:x_explosive","inventory"));
		//Curer
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_CURER),0,new ModelResourceLocation("x_craft:x_curer","inventory"));
		//Dust_Generater
		for(i=0;i<4;i++) ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_DUST_GENERATER),i,new ModelResourceLocation("x_craft:x_dust_generater_"+i,"inventory"));
		//Glass
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_GLASS),0,new ModelResourceLocation("x_craft:x_glass","inventory"));
		//Diamond_Block
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_DIAMOND_BLOCK),0,new ModelResourceLocation("x_craft:x_diamond_block","inventory"));
		//Emerald_Block
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_EMERALD_BLOCK),0,new ModelResourceLocation("x_craft:x_emerald_block","inventory"));
		//Ruby_Block
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_RUBY_BLOCK),0,new ModelResourceLocation("x_craft:x_ruby_block","inventory"));
		//Metal_Block
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_METAL_BLOCK),0,new ModelResourceLocation("x_craft:x_metal_block","inventory"));
		//Covalent_Solid
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_COVALENT_SOLID),0,new ModelResourceLocation("x_craft:x_covalent_solid","inventory"));
		//Phase_Fiber_Block
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_PHASE_FIBER_BLOCK),0,new ModelResourceLocation("x_craft:x_phase_fiber_block","inventory"));
		//Phase_Web_Block
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_PHASE_WEB_BLOCK),0,new ModelResourceLocation("x_craft:x_phase_web_block","inventory"));
		//Transporter
		for(i=0;i<7;i++)
		{
			ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(X_TRANSPORTER),i,new ModelResourceLocation("x_craft:x_transporter","inventory"));
		}
		//Fluid
		...
		ModelLoader.setCustomMeshDefinition(X_FLUID_ITEM,new ItemMeshDefinition()
		{
			...
			{
				return new ModelResourceLocation("x_craft:x_fluid","x_fluid");
			}
		});
		...
		ModelLoader.setCustomMeshDefinition(X_OXYGEN_ITEM,new ItemMeshDefinition()
		{
			...
			public ModelResourceLocation getModelLocation(ItemStack stack)
			{
				return new ModelResourceLocation("x_craft:x_oxygen","x_oxygen");
			}
		});
