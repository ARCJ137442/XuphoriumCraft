...
public class XCreeper extends Elementsx_craft.ModElement
{
	public static final int ENTITYID=1;
	public static final int ENTITYID_RANGED=2;

	public XCreeper(Elementsx_craft instance)
	{
		super(instance,1);
	}
	...
	{
		elements.entities.add(()->EntityEntryBuilder.create().entity(EntityXCreeper.class).id(new ResourceLocation("x_craft","x_creeper"),ENTITYID).name("x_creeper").tracker(64,1,true).egg(-13369549,-16776961).build());
	}
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		RenderingRegistry.registerEntityRenderingHandler(EntityXCreeper.class,renderManager -> {
			return new RenderLiving(renderManager,new ModelCreeper(),0.5f)
			{
				...
				{
					return new ResourceLocation("x_craft:textures/x_creeper.png");
				}
			};
		});
	}
