...
public class XArmor extends Elementsx_craft.ModElement
{
	@GameRegistry.ObjectHolder("x_craft:x_helmet")
	public static final Item X_HELMET=null;
	@GameRegistry.ObjectHolder("x_craft:x_chestplate")
	public static final Item X_CHESTPLATE=null;
	@GameRegistry.ObjectHolder("x_craft:x_leggings")
	public static final Item X_LEGGINGS=null;
	@GameRegistry.ObjectHolder("x_craft:x_boots")
	public static final Item X_BOOTS=null;

	public XArmor(Elementsx_craft instance)
	{
		super(instance,4);
	}
	...
	{
		ModelLoader.setCustomModelResourceLocation(X_HELMET,0,new ModelResourceLocation("x_craft:x_helmet","inventory"));
		ModelLoader.setCustomModelResourceLocation(X_CHESTPLATE,0,new ModelResourceLocation("x_craft:x_chestplate","inventory"));
		ModelLoader.setCustomModelResourceLocation(X_LEGGINGS,0,new ModelResourceLocation("x_craft:x_leggings","inventory"));
		ModelLoader.setCustomModelResourceLocation(X_BOOTS,0,new ModelResourceLocation("x_craft:x_boots","inventory"));
	}
